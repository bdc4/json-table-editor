    ...
    if(!schema) {
        ...
        definitions: {
            table: {
                ...
                headerTemplate:  "{{self.table_name}}",
                format: "grid",
                properties: {
                    table_name: {
                        type: "string",
                        title: "Table Name",
                        description: "Enter table's variable name. i.e: INJURIES_MAJOR",
                        default: "New Table"
                    },
                    events: {
                        title: "Events List",
            ...
            event: {
                ...
                properties: {
                    name: {
                        title: "Title",
                        type: "string",
                        options: {input_width:"50%"}
                    },
                    text: {
                        title: "Textbox Message",
                        type: "string",
                        format: "textarea",
                        options: {input_height:"180px"}
                    },
                    actions: {
                        type: "array",
                        uniqueItems: true,
                        ...
                        items: {
                            type: "string",
                            enum: ["Attack","Run","Talk","Ignore","Investigate","OK"],
